...
$(function() {
	...
	$('#submit-speed').click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Check_dev/retrieveSpeed'),
...
function doTask() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/createTask'),
		data: {
...
function doToken1() {
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveToken1'),
		data: {},
...
function doNDByIN(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveNDByIN'),
		data: {},
		success: function(response9){
			if(response9.success){
...
function doIPRadius() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveIPRadius'),
		data: {},
		success: function(response14) {
			// doToken1();
			if(response14.success){
				clearTimeout(timerWait3);
				if(response14.data.passed_ip > 0) {
					$('#ask-wait-0').modal('hide');
					$('#ask-ticket').addClass('hide');
					$('#show-check').removeClass('hide');
					$('#confirm-ticket').val(response14.data.ticket);
					$('#confirm-nd').val(response14.data.nd);
					$('#confirm-ts').text(response14.data.ts + " WIB");
		...
		success: function(response4) {
			if(response4.success) {
				$.ajax({
					method: 'post',
					dataType: 'json',
					url: site_url('Check_dev/retrieveNDByIP'),
					data: {},
...
function doOokla(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveSpeedOokla'),
		data: {},
...
function doSpeedAcsis() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveSpeedAcsis'),
		data: {},
		success: function(response3) {
...
function doRedaman() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveUkur'),
		data: {},
		success: function(response1) {
...
function doSpeed() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveToken2'),
		data: {},
		success: function(response1) {
			if(response1.success) {
				$.ajax({
					method: 'post',
					dataType: 'json',
					url: site_url('Check_dev/retrievePCRF'),
					data: {},
...
function sendAutoClose(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_dev/retrieveCloseAuto'),
		data: {},
		success: function(response1) {
			if(response1.success) {
