...
$(function() {
	...
	$('#submit-speed').click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Check_embeded/SaveSpeed'),
...
function retrievepassed(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveSpeed'),
		contentType: 'application/json',
		data: {},
...
function doTask() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/createTask'),
		data: {
...
function doToken1() {
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveToken1'),
		data: {},
...
function doIPRadius() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveIPRadius'),
		data: {},
			...
			success: function(response3) {
				...
				if(typeof response3.ip_addr != 'undefined'){
					...
					$.ajax({
						method: 'post',
						dataType: 'json',
						url: site_url('Check_embeded/saveWho'),
						data: {
							ip_addr: ip_addr,
							success: 1,
							request: null,
...
function doOokla(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveSpeedOokla'),
		data: {},
...
function doSpeedAcsis() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveSpeedAcsis'),
		data: {},
...
function doRedaman() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveUkur'),
		data: {},
...
function doSpeed() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveToken2'),
		data: {},
		success: function(response8) {
			if(response8.success) {
				$.ajax({
					method: 'post',
					dataType: 'json',
					url: site_url('Check_embeded/retrievePCRF'),
					data: {},
...
function sendAutoClose(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_embeded/retrieveCloseAuto'),
		data: {
			// close: close
		},
