...
$(function() {
	...
	$('#submit-speed').click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Check_ookla/retrieveSpeed'),
...
function doTask() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/createTask'),
		data: {
			...
			success: function(response1) {
				...
				if(typeof response1.ip_addr != 'undefined'  && typeof response1.username !='undefined') {
					...
					$.ajax({
						method: 'post',
						dataType: 'json',
						url: site_url('Check_ookla/saveWhoIP6'),
						data: {
							ip_addr: ip_addr,
							username: username,							success: 1,
							request: null,
					...
					$.ajax({
						method: 'post',
						dataType: 'json',
						url: site_url('Check_ookla/saveWhoIP4'),
						data: {
							ip_addr: ip_addr,
							success: 1,
							request: null,
...
function doNDByIP() {
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveToken1'),
		data: {},
		success: function(response4) {
			if(response4.success) {
				$.ajax({
					method: 'post',
					dataType: 'json',
					url: site_url('Check_ookla/retrieveNDByIP'),
					data: {},
...
function doOokla(){
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveSpeedOokla'),
		data: {},
...
function doSpeedAcsis() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveSpeedAcsis'),
		data: {},
		success: function(response3) {
...
function doRedaman() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveUkur'),
		data: {},
		success: function(response1) {
...
function doSpeed() {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveToken2'),
		data: {},
		success: function(response1) {
			if(response1.success) {
				$.ajax({
					method: 'post',
					dataType: 'json',
					url: site_url('Check_ookla/retrievePCRF'),
					data: {},
					success: function(response2) {
...
function sendClose(close) {
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Check_ookla/retrieveClose'),
		data: {
			close: close
		},
		success: function(response1) {
