...
$(function() {
	...
	$('#ticket-search-submit').click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Dashboard_detail/jSearchTicket'),
			data: {
	...
	$('#nd-search-submit').click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Dashboard_detail/jSearchND'),
			data: {
				'nd': $('#search-nd').val()
			},
			success: function(response) {
...
function loadOverviewList() {	
	...
	$.ajax({
		method: 'post',
		dataType: 'json',
		url: site_url('Dashboard_detail/jOverviewList'),
		data: {
...
function rebindLinkDetail() {
	...
	.click(function(e) {
		...
		$.ajax({
			method: 'post',
			dataType: 'json',
			url: site_url('Dashboard_detail/jOverviewDetail'),
			data: {
