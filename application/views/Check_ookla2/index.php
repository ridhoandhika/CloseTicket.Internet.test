				...
				<div class="modal-body">
					<div class="info-text">
						...
						<ul>
							...
							<li>jika tidak bisa meng-akses <a href="https://myip.indihome.co.id" target="_blank">myip.indihome.co.id</a>, Lakukan clear cache pada browser/app mytech </li>
							<li>atau Lakukan ipconfig/flushdns bagi yang menggunakan PC/Laptop</li>
							<li>atau gunakan tab penyamaran pada browser anda </li>
							<li>Ulang kembali test <a href="https://myip.indihome.co.id" target="_blank">myip.indihome.co.id</a>, jika berhasil lakukan kembali test SCC </li>
						</ul>
						...
						<ul>
							...
							<li>gunakan tab  penyamaran pada browser anda </li>
							<li>Ulang kembali test SCC</li>
							<li>Jika masih belum berhasil hubungi kontak telegram <a href="tg://user?id=indihomeku_indihomemu">@indihomeku_indihomemu</a> dengan melampirkan no tikcet gangguan, capture gagal SCC dan IP dari <a href="https://myip.indihome.co.id" target="_blank">myip.indihome.co.id</a></li>
						</ul>
						...
						<ul>
							...
							<li>jika tidak berhasil speedtest, Pastikan koneksi anda lancar</li>
						</ul>
					</div>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body">
					...
					<hr />
					<div class="container-fluid">
						<iframe width="100%" height="650px" id="ookla" frameborder="0" src=""></iframe>
					</div>
				</div>
				<div class="modal-footer">
