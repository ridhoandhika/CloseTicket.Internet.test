...
<script>
	<?php
	$ticket = '';
	if(isset($_GET['hardcode']) && isset($hardcode[$_GET['hardcode']])) {
		$ticket = $hardcode[$_GET['hardcode']]['ticket'];
		?>
		let hardcode = '<?php echo $_GET['hardcode'];?>';
		<?php
	}
	?>
</script>
	...
	<div id="wizard">
		<div class="_container">
			<div class="wizard" data-wizard="0" id="ask">
				...
				<input type="text" maxlength="13" class="form-control" id="ticket" placeholder="IN*******" value="<?php echo $ticket;?>">
