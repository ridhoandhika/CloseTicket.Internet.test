	...
	<div id="wizard">
		<div class="_container">
			<div class="wizard" data-wizard="0" id="ask-ticket">
				...
				<div id="wrap-ticket">
					<input type="text" maxlength="13" class="form-control" id="input-ticket" placeholder="masukkan nomor tiket / permintaan" value="<?php echo $this->session->ticket; ?>">
			...
			<div class="wizard hide" data-wizard="1" id="show-check">
				...
				<div id="show-eligible">
					<div class="hide" id="show-eligible-close-y">
						...
						Apakah anda bersedia menutup tiket pelaporan / Permintaan internet Anda?
						<hr />
