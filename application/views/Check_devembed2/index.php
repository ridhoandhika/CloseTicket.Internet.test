		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="row mb-0">
					...
					<div class="col-2">
						<button id="btn" class="refresh-btn" style="all:unset; margin-left:20px;" onclick="reloadOokla()"><i class="fa fa-refresh " style="font-size:26px;color:red"></i></button>
						<!-- <a href="#" id="refreshookla" class="btn-reload ml-6"><i class="fa fa-refresh " style="font-size:26px;color:red"></i></a> -->
					</div>
				</div>
					<!-- <br /> -->
						<div id="uidookla">
