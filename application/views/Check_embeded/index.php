<section id="Main__index">
	<div id="wizard">
		<div class="_container">
			<div class="wizard" data-wizard="0" id="ask-ticket">
				<h5 class="wizard-label">Nomor Tiket / Permintaan</h5>
				<div id="wrap-ticket">
					 <?php 
					if(isset($_REQUEST['ticketId'])){
					?>
						<input type="text" maxlength="13" class="form-control" id="input-ticket"  placeholder="masukkan nomor tiket / permintaan" value="<?php  echo $_REQUEST['ticketId']; ?>">	
					<?php 
					}else {
					?> 
						<input type="text" maxlength="13" class="form-control" id="input-ticket"  placeholder="masukkan nomor tiket / permintaan" value="<?php $this->session->ticket; ?>">
					<?php
					}
					?> 
					<!-- $_REQUEST['ticketid']   $this->session->ticket; -->
					<?php 
					if(isset($_REQUEST['nd'])){
					?>
						<input type="text" maxlength="20" class="form-control" id="input-nd" placeholder="masukan nomor internet" readonly hidden value="<?php echo  $_REQUEST['nd']; ?>">
					<?php 
					}else {
					?>
						<input type="text" maxlength="20" class="form-control" id="input-nd" placeholder="masukan nomor internet" readonly hidden value="<?php $this->session->nd; ?>">
					<?php 
					}
					?>
			...
			<div class="wizard hide" data-wizard="1" id="show-check">
				<div id="show-confirm">
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text">Nomor Tiket / Permintaan</span>
						</div>
				...
				<div id="show-eligible">
					...
					<div class="hide" id="show-eligible-close-n">
						<hr /> 
						Layanan internet anda belum normal.<br />
						<hr />
			...
			<div class="wizard hide" data-wizard="1" id="show-finish-nds">
				<div id="show-finish-failed" class="show-finish-sub">
					tidak mendapatkan output dari GetNDByIN Nossa
					<hr />
					Tiket tetap bisa dilakukan Tech Closed, namun akan melewati proses Mediacare/Saltik.
					<!-- Penutupan tiket pelaporan gangguan internet akan dilakukan melalui konfirmasi 147 -->
					<hr />
					<button class="btn btn-sm btn-light" id="retry">Ok</button>
					<button class="btn btn-sm btn-light" id="btnhelp-nds" data-toggle="modal" data-target="#ask-wait-2">Bantuan</button>
				</div>
			</div>
			...
			<div class="wizard hide" data-wizard="1" id="show-finish-ip">
				<div id="show-finish-failed" class="show-finish-sub">
					terindikasi tidak di jaringan pelanggan
					<hr />
					Tiket tetap bisa dilakukan Tech Closed, namun akan melewati proses Mediacare/Saltik.
					<!-- Penutupan tiket pelaporan gangguan internet akan dilakukan melalui konfirmasi 147 -->
					<hr />
					<button class="btn btn-sm btn-light" id="retry">Ok</button>
					<button class="btn btn-sm btn-light" id="btnhelp-ip" data-toggle="modal" data-target="#ask-wait-2">Bantuan</button>
				</div>
			</div>
			<div class="wizard hide" data-wizard="1" id="show-finish-ipradius">
				<div id="show-finish-failed" class="show-finish-sub">
					tidak mendapat output dari GetIP Radius
					<hr />
					Tiket tetap bisa dilakukan Tech Closed, namun akan melewati proses Mediacare/Saltik.
					<!-- Penutupan tiket pelaporan gangguan internet akan dilakukan melalui konfirmasi 147 -->
					<hr />
	...
	<div class="modal fade" id="error-ticket" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document" data-backdrop="static">
			<div class="modal-content">
				<div class="modal-header" style="text-align:center;">
						<h5 class="modal-title"  id="exampleModalScrollableTitle">Peringatan</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					...
					Nomor tiket / permintaan harus di isi.
					</div>
					<hr />
					<div class="container-fluid">
						<div class="row">
							<div class="col-12" style="text-align:center;">
								<button class="btn btn-sm btn-danger" id="submit-wait-error" >ok</button>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="error-nd" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document" data-backdrop="static">
			<div class="modal-content">
				<div class="modal-header" style="text-align:center;">
						<h5 class="modal-title"  id="exampleModalScrollableTitle">Peringatan</h5>
				...
				<div class="modal-body">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12" style="text-align:center;">
								<button class="btn btn-sm btn-danger" id="submit-wait" >ok</button>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="error-nd-null" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document" data-backdrop="static">
			<div class="modal-content">
			<div class="modal-header" style="text-align:center;">
						<h5 class="modal-title"  id="exampleModalScrollableTitle">Peringatan</h5>
				...
				<div class="modal-body">
					<div class="text-center" style="text-align: center;">
						Service Number tidak boleh kosong
					</div>
					<hr />
					<div class="container-fluid">
						<div class="row">
							<div class="col-12"  style="text-align:center;">
								<button class="btn btn-sm btn-danger" id="submit-wait-null">ok</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body">
					...
					<hr />
					<div class="container-fluid">
						<iframe width="100%" height="650px" id="ookla" frameborder="0" src="https://test-inf-2.speedtestcustom.com"></iframe>
					</div>
				</div>
				<div class="modal-footer">
