<section id="Main__index">
		...
		<div class="modal-dialog modal-dialog-centered" role="document" data-backdrop="static">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					Nomor tiket gangguan harus di isi.
					</div>
					<hr />
					<div class="container-fluid">
						<div class="row">
	...
	<div class="modal fade" id="tiket-error" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document" data-backdrop="static">
			<div class="modal-content">
				<div class="modal-header" style="text-align:center;">
						<h5 class="modal-title"  id="exampleModalScrollableTitle">Peringatan</h5>
				...
				<div class="modal-body">
					<div class="text-center" style="text-align: center;">
					Nomor tiket gangguan tidak Valid
					</div>
					<hr />
					<div class="container-fluid">
						<div class="row">
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body" style="background-color: red;">
					...
					<hr />
					<div class="container-fluid">
						<iframe scrolling="yes" width="100%" height="650px" id="ookla" frameborder="0" src="" allow="geolocation *"></iframe>
					</div>
				</div>
				<div class="modal-footer">
